...
set "save_loc=%nas_base_loc%/paraphrase examples/%corpus%-%data_type%-gpt-4-1-v2"
set "completed_loc=%nas_base_loc%/paraphrase examples/%corpus%-%data_type%-gpt-4-1-v2-completed"
